...
public abstract class NetworkParameters {
    ...
    public static final String ID_MAINNET = "org.deeponion.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.deeponion.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.deeponion.regtest";
    /** Unit test network. */
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        t.setTime(1499843027);
        try {
            // A script containing the difficulty bits and the following message:
            //
            //   "DeepOnion: the most secure coin in the cyberspace!"
            byte[] bytes = Utils.HEX.decode
                    ("00012a32446565704f6e696f6e3a20746865206d6f73742073656375726520636f696e20696e20746865206379626572737061636521");
        ...
        checkState(merkleHash.equals("48a457c277b124a06b568c0036d2c834e918d952c5b2dbf4035d173f50c8d14c"), merkleHash);

        return genesisBlock;
    }

    public static final int TARGET_TIMESPAN = 4 * 60 * 60;  // 4 hours per difficulty cycle, on average.
    public static final int TARGET_SPACING = 4 * 60;  // 4 minutes per PoW block.
